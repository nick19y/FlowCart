package com.flowcart.orderservice.config;
...
public class RabbitMQConfig {
    ...
    // Payment exchange and result queue
    @Bean
    ...
    @Bean
    public Binding paymentConfirmedBinding(Queue paymentResultQueue, TopicExchange paymentExchange) {
        return BindingBuilder
